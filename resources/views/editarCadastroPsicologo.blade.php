...
<div class="container mt-5 py-5">
    ...
    <form method="POST" id="editarCadastroPsicologo" action="/editarCadastroPsicologo/{{$psicologo->id}}" enctype="multipart/form-data">
        ...
        <div id="home">
            ...
            <div class="row">
                    <div class=" col-md-12 d-flex justify-content-end">
                        <button type="submit" class="btn btn-primary  ml-3" id="button-form">Salvar Alterações</button>
                    </div>
                </div>
    </div>
    </form>
    <button type="button" class="btn btn-primary bg-danger text-white ml-3" data-toggle="modal" data-target="#modal{{$psicologo->id}}">Excluir Conta</button>
    ...
    <div class="modal fade" id="modal{{$psicologo->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                <div class="modal-content">
